...
from edge_detector import clean_page as clean, connected_components as cc, defaults, arg, segmentation
...
def main():
    ...
    parser.add_argument('--binary_threshold', help='Binarization threshold value from 0 to 255.', type=int,
    ...
    for blurb in blurbs:
        print(str(blurb.x) + ',' + str(blurb.y) + ' ' + str(blurb.w) + 'x' + str(blurb.h) + ' ' + str(
            blurb.confidence) + '% :' + blurb.text)
