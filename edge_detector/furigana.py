...
from edge_detector import clean_page as clean, connected_components as cc, defaults, arg
...
def estimate_furigana(img, segmentation):
  ...
  columns = scipy.ndimage.filters.gaussian_filter(cleaned, (
  defaults.FURIGANA_VERTICAL_SIGMA_MULTIPLIER * binary_average_size,
  defaults.FURIGANA_HORIZONTAL_SIGMA_MULTIPLIER * binary_average_size))
