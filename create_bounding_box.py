    ...
    with graph.as_default():
        with tf.compat.v1.Session() as sess:
            ...
            if 'detection_masks' in tensor_dict:
                ...
                detection_masks_reframed = tf.cast(tf.greater(detection_masks_reframed, 0), tf.uint8)
                # Follow the convention by adding back the batch dimension
                tensor_dict['detection_masks'] = tf.expand_dims(detection_masks_reframed, 0.5)
...
image = Image.open('ocr_data/zombiimg0015.jpg' )
